...
import { SimpleModal, LGModal } from './helpers/Modal';
import { xKeyGenerator } from '../function/util.ts'
...
function Home() {
    ...
    console.log(xKeyGenerator("5000"))
    const services = [{
    ...
    return (
        <>
            ...
            <div className="m-3">
                ...
                {open === 0 && <LGModal handleClose={() => setOpen(-1)} />}
                {open === 1 && <SimpleModal handleClose={() => setOpen(-1)} />}
                ...
                <div className="w-full mt-8">
                    ...
                    <div className="flex w-full mt-8">
                        <div className="mx-auto w-full px-4 md:w-3/4 lg:w-3/4">
                            <Box sx={{ width: '100%' }}> <TextField fullWidth label="Name" id="fullWidth" /></Box>
                            <Box sx={{ width: '100%', marginTop: '2%' }}> <TextField fullWidth label="Email" id="fullWidth" /></Box>
                            <Box sx={{ width: '100%', marginTop: '2%' }}> <TextField fullWidth multiline rows={4} label="Feedback" id="fullWidth" /></Box>
                            <div className="flex">
