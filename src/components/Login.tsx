...
import { isLoggedIn } from "../function/firebaseFunctions";
            ...
            <div className="w-full h-screen flex items-center justify-center">
                <div className="w-full max-w-md">
                    ...
                    <form className="w-full mx-auto">
                        ...
                        <div className="relative z-0 w-full mb-5 group">
                            <input type="password" name="floating_password" id="floating_password" className="block py-2.5 px-0 w-full text-sm text-black bg-transparent border-0 border-b-2 border-blue-500 outline-none ring-0 focus:border-blue-600 peer" placeholder=" " required />
                        ...
                        <div className="flex">
                            ...
                            <button type="button" className="border ml-auto focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 border-blue-500 text-blue-500 hover:text-white hover:bg-blue-500 focus:ring-blue-800">Submit</button>
                        </div>
                        <div className="flex w-full"><span className="mx-auto">OR</span></div>
                        <button type="button" className="text-white mt-2 w-full bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 me-2 mb-2">
